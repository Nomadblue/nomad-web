...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogUser.website_url'
        db.add_column(u'nomadblog_bloguser', 'website_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogUser.website_url'
        db.delete_column(u'nomadblog_bloguser', 'website_url')
