...
class Country(models.Model):
    code = models.CharField(_('iso country code'), max_length=2, unique=True, help_text='Reference: http://www.iso.org/iso/home/standards/country_codes/country_names_and_code_elements_txt.htm')
...
class BlogHub(models.Model):
    name = models.CharField(_('blog hub'), max_length=255)
...
class Blog(models.Model):
    ...
    hubs = models.ManyToManyField(BlogHub, verbose_name=_('hubs'), blank=True)
...
class Category(models.Model):
    name = models.CharField(_('name'), max_length=100)
    slug = models.SlugField(_('slug'), max_length=50, unique=True)  # Categories are global to all countries & blogs
